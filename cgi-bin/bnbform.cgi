...
# Put the domains below that you will be calling the script from,
# or it won't function at all.

@okaydomains=("http://www.lhsmayer.mn.org/");     

#$SMTP_SERVER="your.smtp.server.name.here";

#IF SMTP IS UNAVAILABLE TO YOU, USE SEND_MAIL- BUT NOT BOTH!
